# 58.ウィンドウ関数～PARTITION BYの利用～
# 59.ウィンドウ関数～ORDER BYの利用～
# 60.PARTITION BYとORDER BYの両方を利用
# 61.フレームの幅の変更（ROWS,RANGE）
# 62.ウィンドウ関数一覧
# 63.SQLの実行順序とウィンドウ関数まとめ
...
# 月ごとの、合計をemployeesのIDで昇順に並び替えてだす
SELECT 
*,
