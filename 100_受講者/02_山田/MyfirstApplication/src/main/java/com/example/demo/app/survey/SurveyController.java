...
//	}
	...
	@PostMapping("/confirm")
	public String confirm(@Validated @ModelAttribute SurveyForm surveyForm, BindingResult result, Model model) {
	...
	public String complete(@Validated @ModelAttribute SurveyForm surveyForm, BindingResult result, Model model,
