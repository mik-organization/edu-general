...
function createApp(args) {
    ...
    app.computed = createdComputedData(app, computedData);

    app.mount = createMounFn(app, render);

    return app;
}

function createMounFn(app, render){
...
function createdComputedData({ publicCtx }, computedData){
    const res = {};
